    ...
    $(document).ready(function () {
        ...
        function sliderAnimations(elements) {
            ...
            elements.each(function () {
                ...
                var animationType = "ae3-animation " + $this.data("animation");
        ...
        window.mainSlider = new Swiper(".ae3-slider", sliderOptions);
